context('Cypress: Assertions ', () => {
    ...
    it('Test de Formu', () =>{
        ...
        //Campo Full Name
        cy.get('#g4072-fullname').type("Juana Espinosa");
        cy.get('#g4072-fullname').should('have.value',"Juana Espinosa");

        //Campo Email
        cy.get('#g4072-email').type("Juanix@mail.com");
        cy.get('#g4072-email').should('have.value',"Juanix@mail.com");
        ...
        cy.get('#g4072-gender-button').should('have.text',"Female");
